...
const showcaseItems = [
    {
        ...
        image: "/images/logistics_fleet.png",
    ...
    },
    {
        ...
        image: "/images/regional_reach.png",
        category: "Network"
    }
];
        ...
        <section className="py-section bg-white overflow-hidden" id="showcase">
            <div className="container mx-auto px-6">
                ...
                <div className="mt-24 relative">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-0 py-16 border-y border-brand/30 relative overflow-hidden group/stats">
                        ...
                        <div className="text-center px-8 border-r border-brand/10 group">
                            <div className="text-6xl font-heading text-brand mb-3 transition-transform group-hover:-translate-y-2">
                                <StatCounter end={500} suffix="K+" />
                            </div>
                            <div className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Tons Dispatched</div>
                        </div>
                        ...
                        <div className="text-center px-8 border-r border-brand/10 group">
                            ...
                            <div className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Fleet Vehicles</div>
                        </div>
                        ...
                        <div className="text-center px-8 border-r border-brand/10 group">
                            ...
                            <div className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Supply Hubs</div>
                        </div>
                        ...
                        <div className="text-center px-8 group">
                            ...
                            <div className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Logistics Ops</div>
                        </div>
                    </div>
                </div>
            </div>
