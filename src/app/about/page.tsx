...
export const metadata: Metadata = {
    title: "Industrial Logistics & Heritage | BS PAI",
    description: "BS PAI: A decades-long legacy of industrial-scale material supply and wholesale logistics excellence. Engineering the future of infrastructure.",
};
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <PageHero 
                ...
                prefix="Decades of Strength"
                subtitle="A robust wholesale platform delivering certified construction materials with industrial-strength logistics for over 25 years."
                imageSrc="/images/about_hero_11zon.webp"
                metadata={[
                    { label: "FOUNDED", value: "2001" },
                    { label: "SITE", value: "HQ-01" },
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="mt-12 lg:mt-24 space-y-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-slate-200">
                            ...
                            <div className="relative group p-16 lg:p-24 overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-200">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h4 className="text-3xl sm:text-4xl lg:text-5xl font-heading mb-10 text-brand-dark uppercase tracking-tight leading-none">
                                        OUR <span className="block text-brand">MISSION.</span>
                                    </h4>
                                    <div className="border-l-2 border-brand/30 pl-8">
                                        <p className="text-slate-500 text-sm sm:text-base lg:text-xl leading-relaxed font-light italic">
                            ...
                            <div className="relative group p-16 lg:p-24 overflow-hidden bg-brand-dark text-white">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h4 className="text-3xl sm:text-4xl lg:text-5xl font-heading mb-10 text-white uppercase tracking-tight leading-none">
                                        OUR <span className="block text-brand">VISION.</span>
                                    </h4>
                                    <div className="border-l-2 border-brand/30 pl-8">
                                        <p className="text-slate-300 text-sm sm:text-base lg:text-xl leading-relaxed font-light italic">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-12">
                            <div className="lg:col-span-8 bg-white border border-slate-200 p-16 lg:p-20 relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-1 bg-brand-dark" />
                                <div className="relative z-10">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-heading mb-8 text-brand-dark uppercase tracking-widest border-b border-slate-100 pb-6">Industrial Commitment</h3>
                                    <p className="text-slate-500 text-lg sm:text-xl lg:text-2xl leading-relaxed font-light italic mb-12 max-w-2xl">
                                        "BS PAI is a specialized platform of wholesale entrepreneurs: expertised, skilled, committed and experienced in material logistics. We share a unified vision in supply chain excellence."
                                    </p>
                                    <Link
                                        href="/inventory"
                                        className="inline-flex items-center gap-6 px-6 py-4 sm:px-10 sm:py-5 bg-brand-dark text-white font-heading text-base sm:text-lg tracking-[0.2em] uppercase transition-all hover:bg-brand hover:text-brand-dark shadow-xl"
                                    >
                                        Explore Inventory <ArrowRight className="w-5 h-5" />
                                    </Link>
                                </div>
                                <Users className="absolute -bottom-10 -right-10 w-48 h-48 sm:w-64 sm:h-64 text-slate-50 -z-10 transition-transform group-hover:scale-110 duration-700" />
                            </div>

                            <div className="lg:col-span-4 bg-brand p-12 sm:p-16 flex flex-col justify-center text-center items-center shadow-2xl relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-1 bg-brand-dark/20" />
                                <div className="text-6xl sm:text-7xl lg:text-8xl font-heading text-brand-dark mb-4 transition-transform group-hover:scale-110 duration-500">25+</div>
                                <h4 className="text-xl sm:text-2xl font-heading text-brand-dark uppercase tracking-widest mb-10 border-y border-brand-dark/10 py-4 w-full">Years Experience</h4>
            ...
            <section className="py-section bg-white">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 xl:gap-12 mt-10 lg:mt-20">
